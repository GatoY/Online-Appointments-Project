...
urlpatterns = [
    ...
    path('editdoginfo/(?P<dogid>[0-9]+)/', views.editdoginfo, name='editdoginfo'),
    ...
    path('cancelconfirm/(?P<appid>[0-9]+)/', views.cancelconfirm, name='cancelconfirm'),
    path('reschedule/', views.reschedule, name='reschedule'),
    path('rescheduledetail/(?P<appid>[0-9]+)/', views.rescheduledetail, name='rescheduledetail'),
