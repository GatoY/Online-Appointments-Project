...
urlpatterns = [
    ...
    path('editdoginfo/<int:dogid>/', views.editdoginfo, name='editdoginfo'),
    ...
    path('cancelconfirm/<int:appid>/', views.cancelconfirm, name='cancelconfirm'),
    path('reschedule/', views.reschedule, name='reschedule'),
    path('rescheduledetail/<int:appid>/', views.rescheduledetail, name='rescheduledetail'),
